...
def product_balance_job(db: Session):
    ...
    for department in department_list:
        print("Started product balances of department: ", department.name)
...
def startup_event():
    ...
    trigger = CronTrigger(hour=12, minute=47, second=00, timezone=timezonetash)  # Set the desired time for the function to run (here, 12:00 PM)
