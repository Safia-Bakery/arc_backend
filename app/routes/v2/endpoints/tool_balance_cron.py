...
def product_balance_job(db: Session):
    ...
    # print(get_all_departments(db=db))
    # print("-----------------------------------------")
    # print(len(department_list), department_list)
...
def startup_event():
    ...
    trigger = CronTrigger(hour=20, minute=46, second=00, timezone=timezonetash)  # Set the desired time for the function to run (here, 12:00 PM)
