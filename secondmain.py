...
#
#
#@secondrouter.get('/category',response_model=Page[schemas.GetCategorySch])
...
#
#
#@secondrouter.get('/category/{id}',response_model=schemas.GetCategorySch)
...
#
#
#@secondrouter.get('/request',response_model=Page[schemas.GetRequestList])
...
#
#
#@secondrouter.get('/request/{id}',response_model=schemas.GetRequestid)
...
#    
#
#@secondrouter.put('/request/attach/brigada')
...
#
#
#@secondrouter.get('/categories/fillials',summary='you can get list of fillials and categories when you are creating request')
...
#
#
#@secondrouter.get('/users',response_model=Page[schemas.UserGetlist])
...
#
#
#@secondrouter.put('/users',response_model=schemas.UserGetlist)
...
#
#
#@secondrouter.get('/users/{id}',response_model=schemas.GetUserIdSch)
...
#    #    )
#
#@secondrouter.post('/tools',response_model=schemas.CreateTool)
...
#
#
#@secondrouter.get('/tools',response_model=Page[schemas.GetToolList])
...
#
#
#@secondrouter.get('/get/fillial/fabrica',response_model=Page[schemas.GetFillialChild])
...
#
#
#@secondrouter.post('/send/message')
